...
public class Image3Activity extends ActionBarActivity {
		 ...
		 LinearLayout linearLayout1 = (LinearLayout) findViewById(R.id.linearLayout1);
		    for(int x=0;x<images.length;x++) {
		        ...
		        //RelativeLayout.LayoutParams params2 = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
		     	...
		     	ImageView mImageView = new ImageView(Image3Activity.this);
	          //  LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
	           ...
	           // mImageView.setBackgroundResource(images[x]);
		        ...
		        TextView text = new TextView(Image3Activity.this);
		        text.setTextSize(12);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
			...
			ImageView imageView = new ImageView(Image3Activity.this);
			LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
			params.setMargins(10, 10, 10, 0);
